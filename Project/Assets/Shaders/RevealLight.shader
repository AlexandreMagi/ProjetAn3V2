...
Shader "_Phosphorescence Custom Shader/RevealLight"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_TexCoord586 = v.texcoord.xy + ( _Vector0 * time588 );
			#ifdef _ISUSINGFLOWGRADIENT_ON
				float4 staticSwitch564 = ( tex2Dlod( _FlowGradient, float4( uv_TexCoord554, 0, 0.0) ) + tex2Dlod( _FlowGradient, float4( uv_TexCoord586, 0, 0.0) ) );
			#else
				float4 staticSwitch564 = temp_cast_2;
			#endif
			float4 flowGradient560 = staticSwitch564;
			#ifdef _ISUSINGFLOWGRADIENT_ON
				float4 staticSwitch583 = ( float4( ase_vertexNormal , 0.0 ) * ( flowGradient560 * _VertexOffset ) );
			#else
				float4 staticSwitch583 = temp_cast_0;
			#endif
			float4 vertexOffset579 = staticSwitch583;
			v.vertex.xyz += vertexOffset579.rgb;
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_TexCoord586 = i.uv_texcoord + ( _Vector0 * time588 );
			#ifdef _ISUSINGFLOWGRADIENT_ON
				float4 staticSwitch564 = ( tex2D( _FlowGradient, uv_TexCoord554 ) + tex2D( _FlowGradient, uv_TexCoord586 ) );
			#else
...
/*ASEBEGIN
Version=17700
49;398;1437;641;-525.4645;-338.2704;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;593;-213.0806,627.9735;Inherit;False;Property;_Vector0;Vector 0;15;0;Create;True;0;0;False;0;0,-0.5;0,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;471;-1203.915,1896.701;Inherit;False;Property;_RevealLightEnabled;RevealLightEnabled;16;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;580;-2978.669,-586.5383;Inherit;False;1225.104;403.3839;Comment;8;583;579;576;575;578;574;577;584;VertexOffset;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;577;-2945.14,-296.3305;Inherit;False;Property;_VertexOffset;VertexOffset;17;0;Create;True;0;0;False;0;0.05;0.05;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;479;-4028.925,360.2855;Inherit;False;477;handpaint;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;574;-2943.085,-399.5461;Inherit;False;560;flowGradient;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;576;-2663.14,-385.3304;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;578;-2778.845,-536.5383;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;584;-2448.017,-545.5222;Inherit;False;Constant;_Float4;Float 4;17;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;575;-2495.668,-468.455;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;583;-2293.181,-521.7047;Inherit;False;Property;_Keyword0;Keyword 0;12;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Reference;564;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;579;-1993.839,-462.6858;Inherit;False;vertexOffset;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;581;-2142.607,331.3219;Inherit;False;579;vertexOffset;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=AAF81346E60ABE9B801502ED85FF232E605A580E