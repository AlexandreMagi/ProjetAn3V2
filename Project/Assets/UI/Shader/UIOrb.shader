...
Shader "_Custom Shader UI/UIOrb"
{
	Properties
	{
		...
		[NoScaleOffset]_Orbdistortiontext("Orb distortion text", 2D) = "white" {}
		[Toggle(_INVERSEFLOWDIRECTION_ON)] _Inverseflowdirection("Inverse flow direction", Float) = 0
		[NoScaleOffset][Normal]_Orbdistortionnormal("Orb distortion normal", 2D) = "bump" {}
		_Distortionamount("Distortion amount", Range( 0 , 1)) = 0
		_Mask("Mask", Range( 0 , 1)) = 1
		_Distortiondirectionandspeed("Distortion direction and speed", Vector) = (0,-0.1,0,0)
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#pragma shader_feature_local _INVERSEFLOWDIRECTION_ON
			...
			uniform sampler2D _Orbdistortiontext;
			uniform sampler2D _Orbdistortionnormal;
			uniform float4 _Orbdistortiontext_ST;
			uniform float _Distortionamount;
			uniform float2 _Distortiondirectionandspeed;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 uv0_Orbdistortiontext = IN.texcoord.xy * _Orbdistortiontext_ST.xy + _Orbdistortiontext_ST.zw;
				float2 MainUvs222_g2 = uv0_Orbdistortiontext;
				float4 tex2DNode65_g2 = tex2D( _Orbdistortionnormal, MainUvs222_g2 );
				...
				float2 panner179_g2 = ( 1.0 * _Time.y * _Distortiondirectionandspeed + MainUvs222_g2);
				float2 temp_output_71_0_g2 = ( temp_output_84_0_g2 + panner179_g2 );
				float4 tex2DNode96_g2 = tex2D( _Orbdistortiontext, temp_output_71_0_g2 );
				float4 orbDistortion54 = ( temp_output_192_0_g2 + ( tex2DNode96_g2 * (temp_output_192_0_g2).a ) );
				float4 temp_output_192_0_g3 = orbDistortion54;
				...
				#ifdef _INVERSEFLOWDIRECTION_ON
				float staticSwitch100 = ( 1.0 - _Time.y );
				#else
				float staticSwitch100 = _Time.y;
				#endif
				float2 temp_cast_0 = (staticSwitch100).xx;
...
/*ASEBEGIN
Version=18000
1920;0;1920;1019;4190.392;357.1546;1;True;False
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;44;-3603.636,121.8769;Inherit;False;0;0;_Color;Shader;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;-2956.609,-40.10115;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;52;-2315.215,-179.8271;Inherit;False;1561.283;562.3608;Comment;7;54;47;49;51;58;48;50;Orb distortion;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;46;-2737.193,-32.05726;Inherit;False;baseSprite;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;48;-2133.547,-129.8271;Inherit;False;46;baseSprite;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;69;-609.0978,20.6181;Inherit;False;1316.887;772.8038;Comment;8;100;99;98;68;63;66;65;64;Flow;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;49;-2265.215,-49.96709;Inherit;True;Property;_Orbdistortiontext;Orb distortion text;10;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.Vector2Node;58;-1883.681,51.80791;Inherit;False;Property;_Distortiondirectionandspeed;Distortion direction and speed;15;0;Create;True;0;0;False;0;0,-0.1;0,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TexturePropertyNode;50;-2219.202,162.5237;Inherit;True;Property;_Orbdistortionnormal;Orb distortion normal;12;2;[NoScaleOffset];[Normal];Create;True;0;0;False;0;None;None;False;bump;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-1922.896,214.8401;Inherit;False;Property;_Distortionamount;Distortion amount;13;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;98;-571.5289,575.5483;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;790.9924,357.9849;Inherit;False;Property;_Mask;Mask;14;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;99;-394.214,542.8153;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;54;-962.7769,57.25125;Inherit;False;orbDistortion;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;64;-210.709,70.6181;Inherit;False;54;orbDistortion;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;63;38.31028,155.6996;Inherit;False;UI-Sprite Effect Layer;1;;3;789bf62641c5cfe4ab7126850acc22b8;18,74,1,204,1,191,0,225,0,242,0,237,0,249,1,186,0,177,0,182,0,229,0,92,1,98,0,234,0,126,0,129,1,130,0,31,2;18;192;COLOR;1,1,1,1;False;39;COLOR;1,1,1,1;False;37;SAMPLER2D;;False;218;FLOAT2;0,0;False;239;FLOAT2;0,0;False;181;FLOAT2;0,0;False;75;SAMPLER2D;;False;80;FLOAT;1;False;183;FLOAT2;0,0;False;188;SAMPLER2D;;False;33;SAMPLER2D;;False;248;FLOAT2;0,0;False;233;SAMPLER2D;;False;101;SAMPLER2D;;False;57;FLOAT4;0,0,0,0;False;40;FLOAT;0;False;231;FLOAT;1;False;30;FLOAT;1;False;2;COLOR;0;FLOAT2;172
...
ASEEND*/
//CHKSM=614B3E8AB8FF5C028D862FB16E5E91DE146ED28D