...
Shader "GravityOrb"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_1_0_g5 = temp_output_67_0;
			float temp_output_72_0 = (0.0 + (( ( temp_output_1_0_g5 - floor( ( temp_output_1_0_g5 + 0.5 ) ) ) * 2 ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0));
			...
			o.Emission = ( edge157 + ( Screenposition138 * Shadowtransform136 ) ).rgb;
...
/*ASEBEGIN
Version=17700
821;130;1271;889;3474.131;80.24109;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;71;-14.46033,2765.02;Inherit;False;Sawtooth Wave;-1;;5;289adb816c3ac6d489f255fc3caf5016;0;1;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1736.926,3226.827;Float;False;Property;_NormalScale;Normal Scale;17;0;Create;True;0;0;False;0;0;0.158;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;113;507.0288,2027.317;Inherit;False;Property;_Emissivecolor;Emissive color;16;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-3015.131,350.7589;Inherit;False;Property;_Darknessamount;Darkness amount;15;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-3061.075,1332.222;Float;False;Property;_ShadowTransform;Shadow Transform;18;0;Create;True;0;0;False;0;0.5;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;164;-518.6683,-222.2625;Inherit;False;Property;_Edgecolor;Edge color;14;1;[HDR];Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;140;-1286.375,407.3085;Inherit;False;1765.561;743.0131;Comment;15;0;162;150;139;148;158;149;141;147;145;146;143;151;167;168;Output;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;167;-451.3055,656.9305;Inherit;False;136;Shadowtransform;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;139;-508.8376,560.285;Inherit;False;138;Screenposition;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;168;-220.0298,562.5707;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;158;-258.0175,461.3595;Inherit;False;157;edge;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;162;-63.21882,516.7158;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClipNode;150;-402.3005,826.0036;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=32DFB4329F2543247D71D8B9B6E552CEA7C4FEC3