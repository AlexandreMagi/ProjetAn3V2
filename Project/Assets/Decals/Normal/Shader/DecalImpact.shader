...
Shader "_Custom Decal Shader/DecalImpact"
{
	Properties
	{
		...
		[Toggle(_USESOFTPARTICLES_ON)] _useSoftParticles("useSoftParticles", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult7 = clamp( ( ( 1.0 - distanceDepth3 ) * _Softparticlespower1 ) , 0.0 , 1.0 );
				...
				float staticSwitch32 = clampResult7;
			#else
				float staticSwitch32 = 1.0;
			#endif
			float softParticles10 = staticSwitch32;
...
/*ASEBEGIN
Version=18000
1920;0;1920;1019;1394.981;892.6803;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;1;-1558.076,-514.4626;Inherit;False;1684.377;326.2766;Comment;9;10;7;6;5;4;3;2;32;33;Edge detection;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-522.9807,-467.6803;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;False;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;32;-326.9807,-430.6803;Inherit;False;Property;_useSoftParticles;useSoftParticles;4;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=723A907FC357959F645304D2F255E90E15EF4F4A