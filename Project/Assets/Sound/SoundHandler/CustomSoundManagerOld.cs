...
public class CustomSoundManagerOld : MonoBehaviour
{
    ...
    private static CustomSoundManagerOld _instance;
    public static CustomSoundManagerOld Instance { get { return _instance; } }
    private void Awake()
    {
