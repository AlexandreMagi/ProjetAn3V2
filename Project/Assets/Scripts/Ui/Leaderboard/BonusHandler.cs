        ...
        switch (progressState)
        {
            ...
            case stateProgress.anim:
                if (upPurcentage(timeAnim))
                {
                    ...
                    {
                        SpawnNewBonusInstance((Main.Instance.AllEndGameBonus[0].addedScore > 0? "+" : "-") + Mathf.Abs(Main.Instance.AllEndGameBonus[0].addedScore).ToString("N0"), Main.Instance.AllEndGameBonus[0].title, Main.Instance.AllEndGameBonus[0].description);
